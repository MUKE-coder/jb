...
## Why I Needed ATLAS {#why-i-needed-atlas}
...
## What is an MCP Server and Why It Matters {#what-is-an-mcp-server}
...
## Part 1: Backend — Go (Gin + GORM) {#part-1-backend}
...
## Part 2: The MCP Server {#part-2-mcp-server}
...
## Part 3: Frontend — Next.js (App Router) {#part-3-frontend}
...
## Connecting Claude Code to Your MCP Server {#connecting-claude}
