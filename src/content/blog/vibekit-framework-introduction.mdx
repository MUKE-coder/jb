...
image: "https://14j7oh8kso.ufs.sh/f/HLxTbDBCDLwf0VdAvuLtvnF3cx4uPCTU9aqg2f0oY8klybGQ"
...
3. **Safety.** A senior-level audit that runs _before_ deploy, not after a security incident.
