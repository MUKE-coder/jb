export const USER = {
  ...
  email: "amJAZGVzaXNodWIuY29t", // base64 encoded
...
- **[Vibekit](https://vibekit.desishub.com)** ([GitHub](https://github.com/MUKE-coder/vibekit)) — A developer toolkit for shipping beautiful, production-ready Next.js apps faster. Curated UI components, patterns, and starter templates for modern fullstack projects.
- **[Vibekit Native](https://native.desishub.com)** ([GitHub](https://github.com/MUKE-coder/vibekit-native)) — The mobile sibling of Vibekit. A React Native + Expo toolkit with batteries-included components and starters for shipping native iOS and Android apps fast.
